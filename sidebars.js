...
const sidebars = {
  ...
  tabletSidebar: [
    {type: 'doc', id: 'tablet', className: 'sidebar-device-tablet'},
    {
      ...
      items: [
        ...
        'quick-start-tablet/app-center-efficient-management',
        'quick-start-tablet/easy-scan-guide',
        'quick-start-tablet/edit-control-center',
    ...
    },
    {
      ...
      items: [
        ...
        'ai-tablet/ask-celia-for-device-help',
        'ai-tablet/calendar-curriculum-schedule',
        'ai-tablet/celia-agents-professional-skills',
        'ai-tablet/celia-deep-problem-solving',
        'ai-tablet/celia-tasks-voice-execution',
        'ai-tablet/immersive-translation-easy-browsing',
    ...
    },
    {
      ...
      items: [
        ...
        'security-tablet/family-anti-fraud-protection',
        'security-tablet/find-device-even-when-powered-off',
        'security-tablet/secure-access-protect-privacy-data',
    ...
    },
    {
      ...
      items: [
        ...
        'camera-tablet/instant-movie-images-to-dynamic-videos',
...

    {
      ...
      items: [
        ...
        'setting-tablet/cute-chubby-hand-theme-game',
        'setting-tablet/dark-mode-comfort',
        'setting-tablet/lock-home-screen-layout',
        'setting-tablet/lock-screen-artistic-signature',
        'setting-tablet/mood-match-theme-lock-screen',
        'setting-tablet/notes-quick-note-summary-and-original-text',
  ...
  wearableSidebar: [
    {type: 'doc', id: 'wearable', className: 'sidebar-device-watch'},
    {
      ...
      items: [
        'wearable-quickstart/appearance',
        'wearable-quickstart/button-gesture',
        'wearable-quickstart/button-screen-gt6',
        'wearable-quickstart/smart-gesture',
        'wearable-quickstart/pair-hmos5-plus',
        'wearable-quickstart/pair-hmos43-minus',
        ...
        'wearable-quickstart/desktop-card-gt6',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-esim/bt-esim-call',
        'wearable-esim/esim-mobile-activate',
        'wearable-esim/esim-mobile-deactivate',
        'wearable-esim/esim-telecom-activate',
        'wearable-esim/esim-telecom-deactivate',
        'wearable-esim/esim-unicom-activate',
        'wearable-esim/esim-unicom-deactivate',
        'wearable-esim/esim-unicom-standalone',
        'wearable-esim/esim-unicom-standalone-deactivate',
        'wearable-esim/esim-replace',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-outdoor/outdoor-adventure',
        'wearable-outdoor/altimeter',
        'wearable-outdoor/beidou-satellite',
        'wearable-outdoor/dolphin-comm',
        'wearable-outdoor/diving',
        'wearable-outdoor/diving-settings',
        'wearable-outdoor/diving-tools',
        'wearable-outdoor/survival-manual',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-life/watchface-mgmt',
        'wearable-life/album-watchface',
        'wearable-life/sticker-watchface',
        'wearable-life/video-watchface',
        'wearable-life/custom-card',
        'wearable-life/live-window',
        'wearable-life/message-mgmt',
        'wearable-life/minus-one-screen',
        'wearable-life/nap-mode',
        'wearable-life/scenario-mode',
        'wearable-life/remote-photo',
        'wearable-life/bt-voice-call-gt6',
        'wearable-life/sms',
        'wearable-life/watch-navigation',
        'wearable-life/xiaoyi',
        'wearable-life/smart-voice-gt6',
        'wearable-life/play-music',
        'wearable-life/control-music-gt6',
        'wearable-life/watch-music-w5',
        'wearable-life/bt-earphone',
        'wearable-life/replace-new-phone',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-health/health-summary',
        'wearable-health/mini-checkup',
        'wearable-health/ecg',
        'wearable-health/ecg-gt6',
        'wearable-health/heartrate',
        'wearable-health/spo2',
        'wearable-health/spo2-gt6',
        'wearable-health/sleep-monitor',
        'wearable-health/sleep-apnea',
        'wearable-health/pulse-arrhythmia',
        'wearable-health/emotion-health',
        'wearable-health/heart-study',
        'wearable-health/breathing-study',
        'wearable-health/vascular-study',
        'wearable-health/women-health-study',
        'wearable-health/menstrual-cycle',
        'wearable-health/hypertension-study',
        'wearable-health/plateau-study',
        'wearable-health/plateau-care',
        'wearable-health/fall-detect-sos',
        'wearable-health/fat-loss',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-sport/workout',
        'wearable-sport/sport-settings',
        'wearable-sport/sport-display',
        'wearable-sport/cycling',
        'wearable-sport/trail-run',
        'wearable-sport/golf',
        'wearable-sport/fat-loss',
        'wearable-sport/offline-map',
        'wearable-sport/track-return',
        'wearable-sport/sport-graffiti',
        'wearable-sport/diving',
        'wearable-sport/watch-cycling-w5',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'wearable-more/charging',
        'wearable-more/upgrade',
        'wearable-more/app-mgmt',
        'wearable-more/multitask',
        'wearable-more/device-info',
        'wearable-more/album-watchface',
        'wearable-more/video-watchface',
        'wearable-more/bt-earphone',
        'wearable-more/bt-audio-gt6',
        'wearable-more/track-return',
        'wearable-more/pair-smartscreen-gt6',
      ],
    },
  ],

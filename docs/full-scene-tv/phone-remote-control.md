...
使用智慧生活App的遥控器功能，可以通过手机控制智慧屏导航、快进/快退、音量调节等功能，随手控制方便快捷，具体操作方法如下：

## 前提条件

1.  将手机与智慧屏连接至同一WLAN，且手机安装的智慧生活App与智慧屏登录同一华为账号。
2.  手机端智慧生活App中已添加智慧屏。参考：[在智慧生活App/智慧屏App中添加智慧屏](https://consumer.huawei.com/cn/support/content/zh-cn15783914/)。
